...
const knowledgeBase = [
  {
    ...
    answer:
      "Our store is open Monday through Saturday from 10:00 AM to 8:00 PM.",
  },
  {
    keywords: ["address", "location", "where", "place"],
    answer:
      "We are located Opposite Rela Hospital, CLC Works Road, Chrompet, Chennai, Tamil Nadu.",
  },
  {
    keywords: ["contact", "phone", "number", "call"],
    answer: "You can reach us directly at 08056095445.",
  },
  {
    keywords: ["medical", "mbbs", "anatomy", "surgery"],
    answer:
      "We stock a full range of MBBS textbooks including Anatomy, Physiology, Pathology, and Surgery.",
  },
  {
    keywords: ["nursing", "bsc", "gnm"],
    answer:
      "We offer B.Sc Nursing, GNM, and Diploma Nursing educational materials.",
  },
  {
    keywords: ["pharmacy", "dpharm", "bpharm"],
    answer:
      "We carry D.Pharm, B.Pharm, Pharmacology, and chemistry reference materials.",
  },
  {
    keywords: ["stationery", "record", "pen", "calculator", "lab"],
    answer:
      "Yes, we sell lab manuals, record books, calculators, pens, and files.",
  },
  {
    keywords: ["map", "direction", "google map"],
    answer:
      "You can find us on Google Maps by searching for 'Chennai Medical Book Centre, Chrompet'.",
  },
  {
    keywords: ["whatsapp"],
    answer: "Chat with us directly on WhatsApp at +91 8056095445!",
  },
];
...
const AIChat = () => {
  ...
  const [messages, setMessages] = useState([
    {
      text: "Hello! I am your AI Assistant. How can I help you find medical books or stationery today?",
      isAi: true,
    },
  ]);
  ...
  const detectCategory = (text) => {
    ...
    if (
      ...
      return "Nursing Books";
    if (
      lower.includes("pharmacy") ||
      lower.includes("bpharm") ||
      lower.includes("dpharm")
    )
      return "Pharmacy Books";
    if (
      lower.includes("equipment") ||
      lower.includes("stethoscope") ||
      lower.includes("bp machine")
    )
  ...
  const handleLeadSubmit = async (e) => {
    ...
    const chatHistory = messages
      .map((m) => `${m.isAi ? "Store AI" : "Customer"}: ${m.text}`)
      .join("\n");
  ...
  return (
    <>
      ...
      >
        <i
          className={`bi ${isOpen ? "bi-x-lg" : "bi-chat-dots-fill"} fs-4 text-white`}
        ></i>
      </motion.button>
          ...
          >
            ...
            <div className="bg-primary text-white p-3 d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center gap-2">
                <div
                  className="rounded-circle bg-white text-primary p-2 d-flex align-items-center justify-content-center"
            ...
            >
              ...
              {isTyping && (
                <div className="d-flex w-100 justify-content-start">
                  <div
                    className="bg-white p-2 px-3 rounded-4 shadow-sm text-muted"
                    style={{ fontSize: "12px" }}
                  >
                ...
                <div className="bg-white p-3 rounded-4 shadow-sm my-2 border">
                  ...
                  >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setLeadInfo({ ...leadInfo, category: e.target.value })
                      }
                    >
                      ...
                      <option value="Doctor Aprons & Scrubs">
                        Doctor Aprons & Scrubs
                      </option>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setLeadInfo({ ...leadInfo, enquiry: e.target.value })
                      }
                    />
                    ...
                    <button
                      type="submit"
                      disabled={isTyping}
                      className="btn btn-gradient btn-sm w-100 mt-1"
                    >
              ...
              {leadSent && (
                <div
                  className="alert alert-success p-2 text-center mb-0"
                  style={{ fontSize: "12px" }}
                >
            ...
            <form
              onSubmit={handleSend}
              className="p-2 bg-white border-top d-flex gap-2"
            >
              <input
                type="text"
