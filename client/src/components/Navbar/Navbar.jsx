  ...
  return (
    ...
    >
      <Container>
        ...
        <Navbar.Brand href="#home" className="fw-bold d-flex align-items-center gap-2 me-auto me-lg-4">
          {logoImg ? (
            <motion.img 
          ...
          <div 
            ...
            style={{ width: '40px', height: '40px', display: logoImg ? 'none' : 'flex' }}
          >
          ...
          <div className="d-flex flex-column leading-tight">
            ...
            <small className="text-muted d-block" style={{ fontSize: '10px', letterSpacing: '0.3px', fontWeight: 500 }}>
        ...
        >
          ...
          >
            <i className={`bi ${expanded ? 'bi-x-lg' : 'bi-list'} fs-2 text-dark`}></i>
          </motion.div>
        </Navbar.Toggle>
