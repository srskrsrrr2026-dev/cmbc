        ...
        <Row className="align-items-center gy-4">
          <Col lg={5} data-aos="fade-right">
            ...
            <div className="glass-panel p-4 mb-4">
              <div className="d-flex gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-muted mb-0">
                   No.22 CLC Work Road, opp. Rela Hospital / SBMCA Near : Rahaat Rooms Chrompet, Chennai-600044
                  </p>
                </div>
              </div>
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted mb-0">Monday - Saturday: 10:00 AM - 8:00 PM</p>
                </div>
              </div>
            </div>
            <div className="d-flex flex-wrap gap-2">
              ...
              <a href="tel:08124127608" className="btn btn-outline-dark rounded-pill">
                <i className="bi bi-telephone-fill me-2"></i>Call Store
              </a>
              <a href="https://wa.me/918056095445" target="_blank" rel="noreferrer" className="btn btn-outline-success rounded-pill">
                <i className="bi bi-whatsapp me-2"></i>WhatsApp
              </a>
            </div>
          </Col>
          <Col lg={7} data-aos="fade-left">
            <div className="glass-card p-2 overflow-hidden shadow-lg" style={{ height: '400px' }}>
              <iframe 
